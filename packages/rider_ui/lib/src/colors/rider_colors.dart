...
abstract class UIColors {
  /// Primary
  static const Color primary = Color.fromARGB(255, 19, 34, 233);

  /// Secondary
  // static const Color secondary = Color(0xFF0094FF);

  /// Tetriary
  static const Color tetriary = Color.fromARGB(255, 187, 255, 0);

  //// Scaffold
  static const Color scaffold = Color(0xFF0094FF);
